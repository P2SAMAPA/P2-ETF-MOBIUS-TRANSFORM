...
from mobius_transform import compute_macro_factor, mobius_sensitivity
...
def main():
    ...
    results = {
        ...
        "mobius_epsilon": config.MOBIUS_EPSILON,
    ...
    out_file = f"output/mobius_transform_{timestamp}.json"
